        ...
        tblProducts = $('#tblProducts').DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    class: 'text-center',
                    render: function (data, type, row) {
                        return `<input type="text" class="form-control input-sm" style="width: 80px;" autocomplete="off" name="cant" value="${row.cant}">`;
                    }
                },
                {
                    targets: [1,2,4],
    ...
    function renderResults(data) {
        ...
        data.forEach(function(item) {
            ...
            resultItem.on('click', function() {
                ...
                const {stock,...item_final} = item
                //vents.add_product(item_final);
