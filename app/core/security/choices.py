...
templates_skin = (
    ('skin-blue', 'Azul'),
    ('skin-blue-light', 'Azul-light'),
    ('skin-green', 'Verde'),
    ('skin-green-light', 'Verde-light'),
    ('skin-red', 'Rojo'),
    ('skin-red-light', 'Rojo-light'),
    ('skin-yellow', 'Naranja'),
    ('skin-yellow-light', 'Naranja-light'),
    ('skin-purple', 'Morado'),
    ('skin-purple-light', 'Morado-light'),
)
...
navbar = (
    ...
    ('navbar-expand navbar-dark', 'navbar-dark'),
