    ...
    _createClass(l, [{
      ...
      value: function handleElementValidated(n) {
        ...
        if (("checkbox" === l || "radio" === l) && n.elements.length > 1 && t(n.element, "form-check-input")) {
          ...
          if (t(_l, "form-check") && t(_l, "form-check-inline")) {
            e(_l, {
              "is-invalid": !n.valid,
              "is-valid": n.valid
            });
      ...
      value: function onMessagePlaced(e) {
        ...
        if (t(n, "input-group")) {
          n.insertBefore(e.messageElement, e.element.nextSibling);
          return;
        }

        var l = e.element.getAttribute("type");

        if (("checkbox" === l || "radio" === l) && t(e.element, "form-check-input") && t(n, "form-check") && !t(n, "form-check-inline")) {
